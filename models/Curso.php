<?php
    class Curso extends Conectar{
        ...
        public function insert_curso($cat_id,$cur_nom,$cur_descrip,$cur_fechini,$cur_fechfin,$inst_id){
            ...
            parent::set_names();
            $sql="INSERT INTO tm_curso (cur_id, cat_id, cur_nom, cur_descrip, cur_fechini, cur_fechfin, inst_id,cur_img, fech_crea, est) VALUES (NULL,?,?,?,?,?,?,'../../public/264659934.png', now(),'1');";
        ...
        public function get_curso(){
            ...
            $sql="SELECT
                ...
                ORDER BY tm_curso.cur_id DESC"; // Orden descendente por el nombre del curso agregado
            $sql=$conectar->prepare($sql);
            $sql->execute();
            return $resultado=$sql->fetchAll();
        }
