...
class Curso extends Conectar
{
    ...
    public function insert_curso($cat_id, $cur_nom, $cur_descrip, $cur_fechini, $cur_fechfin, $inst_id, $cur_fecha_vencimiento)
    {
        $conectar = parent::conexion();
        parent::set_names();
        $sql = "INSERT INTO tm_curso (cur_id, cat_id, cur_nom, cur_descrip, cur_fechini, cur_fechfin, cur_fecha_vencimiento, inst_id, cur_img, fech_crea, est) VALUES (NULL,?,?,?,?,?,?,?,'../../public/264659934.png', now(),'1');";
        ...
        $sql->bindValue(6, $cur_fecha_vencimiento);
        $sql->bindValue(7, $inst_id);
        $sql->execute();
        return $resultado = $sql->fetchAll();
    }

    public function update_curso($cur_id, $cat_id, $cur_nom, $cur_descrip, $cur_fechini, $cur_fechfin, $inst_id, $cur_fecha_vencimiento)
    {
        $conectar = parent::conexion();
        parent::set_names();
        $sql = "UPDATE tm_curso
        ...
        $sql->bindValue(7, $cur_fecha_vencimiento);
