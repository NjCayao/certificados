    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (response.status === "error") {
                // Si hay un error (DNI ya registrado, etc.)
                alert(response.message);  // Mensaje de error como: "Error de registro, el DNI 0000123 ya está registrado."
            } else if (response.status === "success") {
                // Si la inserción o actualización fue exitosa
                alert(response.message);  // Mensaje de éxito: "Usuario registrado correctamente" o "Usuario actualizado correctamente"
...
$(document).ready(function(){
    ...
    $('#usuario_data').DataTable({
        ...
        "ajax":{
            url:"../../controller/usuario.php?op=listarAlumno",
            type:"post"
        },
        "bDestroy": true,
        "responsive": true,
