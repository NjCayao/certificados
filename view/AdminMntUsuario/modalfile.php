        ...
        <div class="modal-content bd-0">
            ...
            <div class="modal-header pd-y-20 pd-x-25">            
                <span>IMPORTANTE: subir imagen en formato PNG, de lo contrario no se guardara. 
                    <br> tamaño maximo permito es de 360x390 píxeles.
                </span>
            </div>
            ...
            <form method="post" id="detalle_form">
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        <input type="file" id="usu_foto" name="usu_foto" onchange="mostrarImagenFirma(this)"/>
                    </div>
...
<script>
    $(document).ready(function () {
        ...
        mostrarVistaPreviaActualAlCargarFormulario("../../public/usuario_fotos/"+usu_id+".png");
    });
    ...
    if (file.size > maxSize) {
        alert('La imagen es demasiado grande. El tamaño máximo permitido es de 360x390 píxeles.');
        return;
    }
