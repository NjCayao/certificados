...
<html lang="es">
  <head>
    ...
    <title><?php echo Titulo::titulo(); ?>::Usuarios</title>
  </head>
  ...
  <body>
    ...
    <div class="br-mainpanel">
      ...
      <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h4 class="tx-gray-800 mg-b-5">Alumnos</h4>
        <p class="mg-b-0">usuario - alumnos</p>
      </div>

      <div class="br-pagebody">
        <div class="br-section-wrapper">
            <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Alumnos</h6>
            <p class="mg-b-30 tx-gray-600">Listado de Alumnos</p>
            <p class="mg-b-30 tx-gray-600" style="background-color: red; color: white;">* Verificar la lista -> si no guarda, es por que el dni del usuario ya existe.</p>
            ...
            <button class="btn btn-outline-primary" id="btnplantilla"><i class="fa fa-upload"></i>  Importar</button>
