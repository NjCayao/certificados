...
<html lang="es">
  <head>
    ...
    <title><?php echo Titulo::titulo(); ?>::Instructor</title>
  </head>
  ...
  <body>
    ...
    <div class="br-mainpanel">
      ...
      <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        ...
        <p class="mg-b-0">Lista de instructores</p>
      </div>
      ...
      <div class="br-pagebody">
        <div class="br-section-wrapper">
            ...
            <button class="btn btn-primary" id="add_button" onclick="nuevo()"><i class="fa fa-plus-square mg-r-10"></i> Nuevo Instructor</button>
