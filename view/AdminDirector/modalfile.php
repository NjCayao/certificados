        ...
        <div class="modal-content bd-0">
            ...
            <div class="modal-header pd-y-20 pd-x-25">            
                <span>IMPORTANTE: subir imagen en formato PNG, de lo contrario no se guardara. 
                    <br> tamaño maximo permito es de 450px * 400px
                </span>
            </div>
...
<script>
    $(document).ready(function () {
        ...
        // mostrarVistaPreviaActualAlCargarFormulario("../../public/firma_direc/"+inst_id+".png");
    });
    ...
    if (file.size > maxSize) {
        alert('La imagen es demasiado grande. El tamaño máximo permitido es de 450x400 píxeles.');
        return;
    }
